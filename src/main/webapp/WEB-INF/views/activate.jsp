...
<section class="container section auth-narrow"><div class="form-card"><p class="eyebrow">MỘC SÁCH / TÀI KHOẢN</p><h1>Kích hoạt tài khoản</h1><p class="muted">Mã xác minh có hiệu lực 10 phút và chỉ dùng một lần.</p>
